...
const heroBanners = [
  {
    ...
    cta: "Shop Now",
    href: "/browse?collection=hair-tools",
...
const departments = [
  ...
  { name: "Hair Tools", slug: "hair-tools", icon: "💇" },
...
const promoBanners = [
  ...
  },
  {
    ...
    subtitle: "Dresses, sets & more",
    tag: "TRENDING",
    href: "/browse?collection=womens-fashion",
    image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&q=80",
    color: "bg-gradient-to-br from-purple-900 to-violet-900",
  },
  {
    title: "Jewellery",
    subtitle: "Rings, chains & bracelets",
    tag: "BEST SELLER",
    href: "/browse?collection=jewellery",
    image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=600&q=80",
    color: "bg-gradient-to-br from-amber-900 to-yellow-900",
  },
  {
    title: "Beauty",
    subtitle: "Skin care & gua sha",
    tag: "NEW IN",
    href: "/browse?collection=beauty",
