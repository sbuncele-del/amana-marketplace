...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-[#D4A843] text-white hover:bg-[#B8922E] shadow-sm",
        secondary: "bg-[#2E7D32] text-white hover:bg-[#1B5E20]",
        outline: "border-2 border-[#D4A843] text-[#D4A843] hover:bg-[#D4A843]/10",
        ghost: "hover:bg-gray-100 text-gray-700",
        dark: "bg-[#1A1A2E] text-white hover:bg-[#16213E]",
        destructive: "bg-red-600 text-white hover:bg-red-700",
        link: "text-[#D4A843] underline-offset-4 hover:underline p-0 h-auto",
      },
      size: {
